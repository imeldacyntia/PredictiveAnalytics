# -*- coding: utf-8 -*-
"""09 mei PredictiveAnalytics.ipynb
...
1. **Age vs Charges (0.45)**
   Terdapat korelasi positif yang cukup kuat antara usia (age) dan biaya asuransi (charges). Artinya, semakin tua usia seseorang, cenderung semakin tinggi biaya asuransinya. Ini masuk akal karena risiko kesehatan meningkat seiring bertambahnya usia.

2. **BMI vs Charges (-0.06)**
   Korelasi antara BMI dan charges sangat lemah dan negatif, menunjukkan bahwa BMI tidak terlalu berkorelasi dengan biaya asuransi secara langsung dalam dataset ini. Namun, ini bisa berubah jika BMI dibagi menjadi kategori seperti obesitas atau tidak.

3. **Children vs Charges (0.09)**
   Korelasi juga sangat lemah antara jumlah anak dan biaya asuransi, yang menunjukkan bahwa faktor ini mungkin tidak terlalu berpengaruh terhadap besarnya charges.

4. **Korelasi antar prediktor rendah**
   Korelasi antar variabel independen seperti age, bmi, dan children juga sangat rendah, artinya multikolinearitas tidak menjadi masalah serius dalam model regresi nantinya.
